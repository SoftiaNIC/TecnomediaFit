...
Estas tareas resumen el estado de preparacion del alcance. Las tareas operativas del cambio inicial viven en `openspec/changes/define-fit-studio-mvp/tasks.md`.
...
- [x] Definir spec de plataforma.
- [x] Definir spec de membresias y pagos.
- [x] Definir spec de horarios y clases.
- [x] Definir spec de empleados y asistencia.
- [x] Definir spec de inventario y creditos.
